...
/**
 * Jist Theme with Material 3 Expressive design.
 * Uses Material You (dynamic color) on Android 12+, falls back to custom Jist colors.
...
fun JistTheme(
    ...
    MaterialTheme(
        ...
        typography = TypographyExpressive,
        content = content
    )
}
