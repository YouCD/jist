            ...
            switch (key.type) {
                case ActivityManager.INTENT_SENDER_ACTIVITY:
                    try {
                        ...
                        // When a system process (UID 1000/ROOT) sends a PendingIntent, skip the
                        // originating PI's creator BSP check. This enables NAF (Notification Action
                        // Framework) to perform notification content intents even after the
                        // notification's 30-second BAL allowlist window has expired.
